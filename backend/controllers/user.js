...
export const register = async (req, res) => {
  ...
  try {
    const { rows } = await db.query('INSERT INTO userinfo(username, password, create_date) VALUES($1, $2, to_timestamp($3/1000.0)) RETURNING username',
    ...
    return res.status(123).json({ error: 'user insertion error' });
  }
};
